...
<div id="header" class="header {{ $headerClass }}">
	...
	<div class="navbar-header">
		...
		@endif
		<a href="index.html" class="navbar-brand"><span class="navbar-logo"></span> <b>Si Agen Talas</b></a>
		@if ($headerMegaMenu)
	...
	<ul class="navbar-nav navbar-right">
		...
		<li class="dropdown navbar-user">
			<a href="#" class="dropdown-toggle" data-toggle="dropdown">
				...
				<span class="d-none d-md-inline">{{ Auth::user()->nama_lengkap }} | <i class=""> {{Auth::user()->role}}  </i> </span> <b class="caret"></b>
			</a>
